...
!function ($) {
    ...
    Validator.prototype = {
         ...
         */, validators: {
            ...
            }, requiredifotherisempty: function (val, elm) {
                return this.required($(elm).val()) || this.required(val);
            }
        }
    ...
    $.fn.parsley.defaults = {
        ...
        , showErrorMessages: false                    // Set to false if you don't want the error elements but still want the classes to be set on the inputs
